#modified from Katherine Carbeck
...
########################################
#######################################
##For CA birds, I am strugglint go get sort to work. Memory requirements are killing the machine and it isn't efficient to use samtools on this many sampoes. Modified this loop to map files and pipe to a bam file
